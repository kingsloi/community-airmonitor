...
export default {
    ...
    computed: {
        ...
        overallAirQuality() {
            const pm1 = this.getOverallAqiScore(this.airshit.data.PM1REALTIME && this.airshit.data.PM1REALTIME.aqi || 0);
    ...
    methods: {
        ...
        initMap() {
            ...
            this.$store.state.beaches.data.forEach((beach) => {
                ...
                L.marker([beach.lat, beach.long], { icon: beachIcon, opacity: beachOpacity }).bindPopup(`
                    ...
                    <a href="https://portal.idem.in.gov/BeachAlert/beach-info/?id=${encodeURIComponent(beach.id)}" target="_blank">sampling results &amp; details</a>
                `).addTo(map);
            });
        },
        ...
        getTotalAirQualityAqiScore(airshit) {
            ...
            const pm1 = airshit.PM1REALTIME && airshit.PM1REALTIME.aqi || 0;
